...
//      */
//     parseAllRestaurants() {
//         const numRestaurants = tripLength * 3; 
//         restaurantsList = []; 
//         for(let i = 0; i < surveyData.length; i++) {
//             restaurantsList.push(surveyData[i].restaurants); 
                    // if(surveyData[i].restaurant1) {
                    //     restaurantsList.push("sushi"); 
                    // }
                    // if(surveyData[i].restaurant2) {
                    //     restaurantsList.push("sushi"); 
                    // }
                    // if(surveyData[i].restaurant3) {
                    //     restaurantsList.push("sushi"); 
                    // }
                    // if(surveyData[i].restaurant4) {
                    //     restaurantsList.push("sushi"); 
                    // }
                    // if(surveyData[i].restaurant5) {
                    //     restaurantsList.push("sushi"); 
                    // }
                    // if(surveyData[i].restaurant6) {
                    //     restaurantsList.push("sushi"); 
                    // }
                    // if(surveyData[i].restaurant7) {
                    //     restaurantsList.push("sushi"); 
                    // }
                    // if(surveyData[i].restaurant8) {
                    //     restaurantsList.push("sushi"); 
                    // }
                    // if(surveyData[i].restaurant9) {
                    //     restaurantsList.push("sushi"); 
                    // }
//         }
//     }
